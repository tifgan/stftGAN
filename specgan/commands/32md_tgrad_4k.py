...
print(np.max(tgrads[:, :128, :]))
print(np.min(tgrads[:, :128, :]))
print(np.mean(tgrads[:, :128, :]))

dataset = Dataset(np.stack([preprocessed_images[:, :128], tgrads[:, :128]], axis=-1))

time_str = 'commands_md32_tgrads_4k_2'
...
params['net']['shape'] = [128, 128, 2] # Shape of the image
