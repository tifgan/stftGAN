...
fake_signals = np.squeeze(wgan.generate(N=nsamples, z=d2, checkpoint=200000))
...
scipy.io.savemat('commands_inception_16k_md64_tgrad_fgrad_200k.mat', {"original": real_signals, "generated": fake_signals})