...
print(np.max(fgrads[:, :128, :]))
print(np.min(fgrads[:, :128, :]))
print(np.mean(fgrads[:, :128, :]))

dataset = Dataset(np.stack([preprocessed_images[:, :128], tgrads[:, :128], fgrads[:, :128]], axis=-1))

time_str = 'commands_md64_tgrads_fgrads_4k'
...
params['net']['shape'] = [128, 128, 3] # Shape of the image
