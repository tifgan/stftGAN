...
time_str = 'commands_md64_8k_squared'
...
fake_signals = np.squeeze(wgan.generate(N=nsamples, z=d2, checkpoint=150000))

real_signals = ((real_signals-1)*5)
fake_signals = ((fake_signals-1)*5)
...
scipy.io.savemat('commands_inception_16k_md64_squared_150k.mat', {"original": real_signals, "generated": fake_signals})